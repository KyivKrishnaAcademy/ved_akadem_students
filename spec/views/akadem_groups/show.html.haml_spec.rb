...
describe 'academic_groups/show' do
  ...
  describe 'common with restricted rights' do
    ...
    And do
      expect(rendered).to have_text(I18n.t('activerecord.attributes.academic_group.establ_date'))
      expect(rendered).to have_text(I18n.l(group.establ_date))
    end

    And do
      expect(rendered).to include(I18n.t('activerecord.attributes.academic_group.group_description'))
      expect(rendered).to include(group.group_description)
    end
