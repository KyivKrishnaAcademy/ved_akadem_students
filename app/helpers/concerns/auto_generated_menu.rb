module AutoGeneratedMenu
  ...
  def generate_menu_group(name, plural_name, icon)
    ...
    html << content_tag(:ul, generate_items(name, plural_name, new_path, list_path))
  ...
  def generate_items(name, plural_name, new_path, list_path)
