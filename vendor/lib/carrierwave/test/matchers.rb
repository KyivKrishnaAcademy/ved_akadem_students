unless Bundler.environment.specs.to_hash['carrierwave'].first.version.to_s == '0.10.0'
  puts "\e[5m\nTODO: check if we are safe to remove vendor/lib/carrierwave/test/matchers.rb"
  puts "      and use carrierwave/test/matchers\n\e[0m"
end
